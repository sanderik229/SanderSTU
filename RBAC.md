...
- Менеджер (Manager):Создание и управление своими объявлениями и пакетами, отчеты.
- Блоггер (Blogger):  Операционное управление контентом рекламы и заявками клиентов .
